...
import { IconLeft, IconRefresh, IconRight } from './Icons'

export default function ZenMode() {
  const [store] = dataStore
  const tweet = createMemo(() => store.selectedTweet)
  return (
    <Show when={tweet()}>
      <div class="relative flex h-full w-full flex-col bg-white dark:bg-gray-800 ">
        ...
        <footer class="sticky bottom-0 mx-auto flex h-14 w-[40rem] items-center justify-between gap-4 bg-white pt-4 dark:bg-gray-800">
          <span>
            <IconLeft />
          </span>
          <span>
